...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar la nacionalidad de un atleta dado");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le pide al usuario el nombre de un atleta, lo busca y luego le muestra 
	 * al usuario el país que el atlta representa. 
	 */
	
	private void  ejecutarbusquedapaisatleta()
	{
		System.out.println("\n"+ "País del Atleta"+"\n");
		String nombre = input("Por favor ingrese el nombre del atleta: ");
		String paisatleta =  calculadora.paisdelatleta(nombre);
		System.out.println("El atleta "+ nombre + " representa el país de " + paisatleta);
