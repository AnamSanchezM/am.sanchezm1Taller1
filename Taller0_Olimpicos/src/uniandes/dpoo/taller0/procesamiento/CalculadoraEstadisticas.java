...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Compila el país del atleta. 
	 * 
	 * @param atleta el nombre del atleta de interés. 
	 * @return Un string con el país del atleta pasado por parametro. 
	 * 
	 * 		   Si no se encuentra el atleta con el nombre indicado, se retorna null.
	 * 
	 */
